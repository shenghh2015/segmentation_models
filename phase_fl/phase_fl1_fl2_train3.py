...
def get_training_augmentation(dim, rot = 0):
    train_transform = [
        ...
        A.ShiftScaleRotate(scale_limit=0.5, rotate_limit=rot, shift_limit=0.1, p=1, border_mode=cv2.BORDER_REFLECT),
 
        A.PadIfNeeded(min_height=dim, min_width=dim, always_apply=True, border_mode=cv2.BORDER_REFLECT),
