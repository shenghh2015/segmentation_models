...
# turing
python train_neuron.py --net_type Unet --backbone efficientnetb3 --dataset spheroids_v3 --subset train --epoch 800 --dim 512 --loss mse --batch_size 4 --rot 50 --lr 5e-4 --pre_train True --gpu 0 --fl_ch fl1 --ch_in 3 --ch_out 3 --docker False
python train_neuron.py --net_type Unet --backbone efficientnetb3 --dataset spheroids_v3 --subset train --epoch 800 --dim 512 --loss mse --batch_size 4 --rot 50 --lr 5e-4 --pre_train True --gpu 7 --fl_ch fl2 --ch_in 3 --ch_out 3 --docker False
