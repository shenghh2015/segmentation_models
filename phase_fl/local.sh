...
## compton
python train_neuron.py --net_type Unet --backbone efficientnetb3 --dataset spheroids_v4 --subset train --epoch 800 --dim 512 --loss mse --batch_size 4 --rot 50 --lr 1e-4 --pre_train True --gpu 0 --fl_ch fl1 --ch_in 3 --ch_out 3 --best_select True --scale 100. --docker False
python train_neuron.py --net_type Unet --backbone efficientnetb3 --dataset spheroids_v4 --subset train --epoch 800 --dim 512 --loss mse --batch_size 4 --rot 50 --lr 1e-4 --pre_train True --gpu 1 --fl_ch fl2 --ch_in 3 --ch_out 3 --best_select True --scale 100. --docker False
python train_neuron.py --net_type Unet --backbone efficientnetb3 --dataset spheroids_v5 --subset train --epoch 800 --dim 512 --loss mse --batch_size 4 --rot 50 --lr 1e-4 --pre_train True --gpu 2 --fl_ch fl1 --ch_in 3 --ch_out 3 --best_select True --scale 100. --docker False
python train_neuron.py --net_type Unet --backbone efficientnetb3 --dataset spheroids_v5 --subset train --epoch 800 --dim 512 --loss mse --batch_size 4 --rot 50 --lr 1e-4 --pre_train True --gpu 7 --fl_ch fl2 --ch_in 3 --ch_out 3 --best_select True --scale 100. --docker False
## turing
python train_neuron.py --net_type Unet --backbone efficientnetb6 --dataset spheroids_v4 --subset train --epoch 800 --dim 512 --loss mse --batch_size 2 --rot 50 --lr 1e-4 --pre_train True --gpu 8 --fl_ch fl1 --ch_in 3 --ch_out 3 --best_select True --scale 100. --docker False
python train_neuron.py --net_type Unet --backbone efficientnetb6 --dataset spheroids_v4 --subset train --epoch 800 --dim 512 --loss mse --batch_size 2 --rot 50 --lr 1e-4 --pre_train True --gpu 9 --fl_ch fl2 --ch_in 3 --ch_out 3 --best_select True --scale 100. --docker False

## Dec. 6, 2020
python train_neuron.py --net_type Unet --backbone efficientnetb7 --dataset spheroids_v5 --subset train --epoch 800 --dim 512 --loss mse --batch_size 6 --rot 50 --lr 5e-4 --pre_train True --gpu 2 --fl_ch fl1 --ch_in 3 --ch_out 1 --best_select True --scale 50. --docker False
python train_neuron.py --net_type Unet --backbone efficientnetb7 --dataset spheroids_v5 --subset train --epoch 800 --dim 512 --loss mse --batch_size 6 --rot 50 --lr 5e-4 --pre_train True --gpu 3 --fl_ch fl2 --ch_in 3 --ch_out 1 --best_select True --scale 50. --docker False
python train_neuron.py --net_type Unet --backbone efficientnetb7 --dataset spheroids_v4 --subset train --epoch 800 --dim 512 --loss mse --batch_size 6 --rot 50 --lr 5e-4 --pre_train True --gpu 6 --fl_ch fl1 --ch_in 3 --ch_out 1 --best_select True --scale 50. --docker False
...
python train_exp.py --net_type Unet --backbone efficientnetb6 --dataset neuron_trn_tst_v3 --subset train --epoch 800 --dim 512 --loss mse --batch_size 2 --rot 50 --lr 5e-4 --pre_train True --gpu 8 --fl_ch fl1 --ch_in 3 --ch_out 1 --best_select True --scale 1. --docker False --extra True
python train_exp.py --net_type Unet --backbone efficientnetb6 --dataset neuron_trn_tst_v3 --subset train --epoch 800 --dim 512 --loss mse --batch_size 2 --rot 50 --lr 5e-4 --pre_train True --gpu 9 --fl_ch fl2 --ch_in 3 --ch_out 1 --best_select True --scale 1. --docker False --extra True
