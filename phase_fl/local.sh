...
## Dec. 4, 2020
python train_model.py --net_type Unet --backbone efficientnetb7 --dataset spheroids_v4 --subset train --epoch 800 --dim 512 --loss mse --batch_size 6 --rot 50 --lr 1e-4 --pre_train True --gpu 1 --fl_ch fl1 --ch_in 3 --ch_out 3 --best_select True --scale 1.0