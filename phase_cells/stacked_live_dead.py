...
model_name = 'stacked-livedead-net-{}-bone-{}-pre-{}-epoch-{}-batch-{}-lr-{}'.format(args.net_type, args.backbone, args.pre_train, args.epoch, args.batch_size, args.lr)
print(model_name)

os.environ['CUDA_VISIBLE_DEVICES'] = args.gpu


DATA_DIR = './data/live_dead'
