...
python deeply_train.py --net_type DUNet --backbone efficientnetb3 --pre_train True --batch_size 4 --dim 512 --epoch 2 --lr 5e-4 --dataset live_dead --train 900 --gpu 1 --loss focal+dice