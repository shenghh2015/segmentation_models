...
python single_train_v2.py --net_type Unet --backbone efficientnetb3 --pre_train True --batch_size 8 --dim 256 --epoch 1 --lr 5e-4 --dataset cell_cycle_1984_v2 --train 1100 --gpu 0 --loss focal+dice --filters 256 --upsample upsampling