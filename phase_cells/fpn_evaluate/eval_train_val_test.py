...
parser.add_argument("--subset", type=str, default = 'test')  # 'train', 'val', 'test'
...
# model_name = 'cellcycle-net-Unet-bone-efficientnetb3-pre-True-epoch-120-batch-2-lr-0.0005-down-True-dim-1024-train-1100-bk-0.5-rot-0-set-1984_v2-ext-True-fact-1-loss-focal+dice'
# model_name = 'cellcycle-net-Unet-bone-efficientnetb1-pre-True-epoch-200-batch-7-lr-0.0005-down-True-dim-800-train-1100-bk-0.5-rot-0.0-set-1984'
...
# model_name = 'cellcycle-net-Unet-bone-efficientnetb3-pre-True-epoch-300-batch-4-lr-0.0005-down-True-dim-800-train-1100-bk-0.5-rot-0.0-set-1984'
