...
print('image batch shape:');print(train_dataloader[0][0].shape); 
print('flu batch shape:');print(train_dataloader[0][1].shape);
print('flu value range: [{:.4f} {:.4f}]'.format(train_dataloader[0][1].min(), train_dataloader[0][1].max()))
