...
JOB: python single_train_v3.py --net_type FPN --backbone efficientnetb0 --pre_train True --batch_size 8 --dim 512 --epoch 400 --lr 5e-4 --dataset live_dead --ext False --train 900 --gpu 0 --loss focal+dice --filters 256 --upsample upsampling --reduce_factor 1.0
JOB: python single_train_v3.py --net_type FPN --backbone efficientnetb1 --pre_train True --batch_size 8 --dim 512 --epoch 400 --lr 5e-4 --dataset live_dead --ext False --train 900 --gpu 1 --loss focal+dice --filters 256 --upsample upsampling --reduce_factor 1.0
JOB: python single_train_v3.py --net_type FPN --backbone efficientnetb2 --pre_train True --batch_size 8 --dim 512 --epoch 400 --lr 5e-4 --dataset live_dead --ext False --train 900 --gpu 2 --loss focal+dice --filters 256 --upsample upsampling --reduce_factor 1.0
JOB: python single_train_v3.py --net_type FPN --backbone efficientnetb3 --pre_train True --batch_size 6 --dim 512 --epoch 400 --lr 5e-4 --dataset live_dead --ext False --train 900 --gpu 3 --loss focal+dice --filters 256 --upsample upsampling --reduce_factor 1.0