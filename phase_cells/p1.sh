...
python single_train.py --net_type Nestnet --backbone efficientnetb0 --pre_train True --batch_size 4 --dim 512 --epoch 60 --lr 5e-4 --dataset live_dead --train 900 --gpu 1 --loss focal+dice