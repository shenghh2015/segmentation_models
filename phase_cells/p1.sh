...
python cell_cycle.py --net_type Unet --backbone efficientnetb3 --pre_train True --batch_size 4 --dim 512 --down_factor 1 --epoch 200 --dataset cell_cycle2 --lr 5e-4 --train 1100 --gpu 1 --loss jaccard
