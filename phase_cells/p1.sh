...
python deeply_train.py --net_type DUNet --backbone efficientnetb3 --pre_train True --batch_size 2 --dim 800 --epoch 1 --lr 5e-4 --dataset cell_cycle_1984_v2 --train 1100 --gpu 0 --loss focal+dice