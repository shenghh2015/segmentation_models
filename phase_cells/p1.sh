...
python life_cycle_flu.py --net_type Unet --backbone efficientnetb3 --pre_train True --batch_size 2 --dim 800 --epoch 200 --lr 5e-4 --train 1100 --filtered True --gpu 1 --loss mse