...
python life_cycle_flu.py --net_type Unet --backbone efficientnetb3 --pre_train False --batch_size 1 --dim 1024 --epoch 100 --lr 5e-4 --train 1100 --filtered False --gpu 1 --loss mse --act_fun relu --channels fl2 --dataset cell_cycle_1984_v2 --flu_scale 1.0